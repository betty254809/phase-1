...
#![Line chart showing annual accident trends.](sheet 1.png)

#2. **Top 10 Aircraft Models in Accidents**B
#![ar chart highlighting models with most incidents.](sheet 2.png)

#3. **Weather Condition Impact on Aircraft Damage**S
#![tacked bar chart comparing accident severity under different weather conditions.](sheet 3.png)
